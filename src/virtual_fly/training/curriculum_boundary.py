"""Boundary-band and gate-frontier curriculum policy.

This module controls episode reset conditions only; it never emits actions or
updates neural weights directly.
"""
