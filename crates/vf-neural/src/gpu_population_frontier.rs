...
use crate::{
    ConnectomeSnapshot, NeuralParams, NeuralState, OutgoingPropagationGraph,
    PlasticFastGraph, Stimulus,
};
...
impl GpuPopulationRuntime {
    ...
    async fn new_async(
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("population_frontier.wgsl"))),
        });
    ...
    pub fn outgoing_edge_count(&self) -> usize { self.outgoing_edge_count }
    ...
    pub fn transaction_stats(&self, slot: usize, weight_max: f32) -> Result<TransactionStats> {
        ...
        for txn in &all[start..end] {
            ...
            if shift_changed || lower_changed || upper_changed { dirty_edges += 1; }
